...
public class Satyr extends Mage {
    ...
    public void loadAnimations() {
        addAnimation("idle", loadTexture("satyr/Idle.png"), 7, 0.1f);
        addAnimation("walk", loadTexture("satyr/Walk.png"), 12, 0.04f);
        addAnimation("attack", loadTexture("satyr/Attack.png"), 8, 0.15f);
        addAnimation("attack2", loadTexture("satyr/Attack.png"), 8, 0.10f);
        addAnimation("attack3", loadTexture("satyr/Attack.png"), 8, 0.15f);
        addAnimation("run", loadTexture("satyr/Walk.png"), 12, 0.08f);
        addAnimation("jump", loadTexture("satyr/Walk.png"), 12, 0.09f);
        addAnimation("protect", loadTexture("satyr/Attack.png"), 8, 2f);
        addAnimation("dead", loadTexture("satyr/Dead.png"), 4, 0.15f);
        addAnimation("hurt", loadTexture("satyr/Hurt.png"), 4, 0.09f);
        addAnimation("charge", loadTexture("satyr/Charge.png"), 8, 0.09f);
    }
}
