...
public class DarkMage extends Mage {
    ...
    public void loadAnimations() {
        ...
        addAnimation("idle", loadTexture(asset+"Idle.png"), 8, 0.1f);
        addAnimation("walk", loadTexture(asset+"Walk.png"), 7, 0.1f);
        addAnimation("attack", loadTexture(asset+"Attack_1.png"), 7, 0.05f);
        addAnimation("attack2", loadTexture(asset+"Attack_2.png"), 9, 0.05f);
        addAnimation("attack3", loadTexture(asset+"Magic_arrow.png"), 6, 0.05f);
        addAnimation("attack4", loadTexture(asset+"Magic_sphere.png"), 16, 0.05f);
        addAnimation("run", loadTexture(asset+"Run.png"), 8, 0.01f);
        addAnimation("jump", loadTexture(asset+"Jump.png"), 8, 0.09f);
        addAnimation("protect", loadTexture(asset+"Attack_1.png"), 7, 2f);
        addAnimation("dead", loadTexture(asset+"Dead.png"), 4, 0.15f);
        addAnimation("hurt", loadTexture(asset+"Hurt.png"), 4, 0.09f);
    }
}
