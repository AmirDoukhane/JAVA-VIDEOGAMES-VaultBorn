...
public class DarkWarrior extends Player {
    ...
    public void loadAnimations() {
        ...
        addAnimation("idle", loadTexture(assets+"Idle.png"), 6, 0.1f);
        addAnimation("walk", loadTexture(assets+"Walk.png"), 9, 0.1f);
        addAnimation("attack", loadTexture(assets+"Attack_1.png"), 4, 0.15f);
        addAnimation("attack2", loadTexture(assets+"Attack_2.png"), 5, 0.10f);
        addAnimation("attack3", loadTexture(assets+"Attack_3.png"), 4, 0.15f);
        addAnimation("run", loadTexture(assets+"Run.png"), 8, 0.08f);
        addAnimation("jump", loadTexture(assets+"Jump.png"), 9, 0.09f);
        addAnimation("protect", loadTexture(assets+"Protect.png"), 2, 2f);
        addAnimation("dead", loadTexture(assets+"Dead.png"), 6, 0.15f);
        addAnimation("hurt", loadTexture(assets+"Hurt.png"), 3, 0.09f);
    }
}
