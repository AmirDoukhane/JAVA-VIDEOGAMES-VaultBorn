...
public class LightMage extends Mage {
    ...
    public void loadAnimations() {
        ...
        addAnimation("idle", loadTexture(asset+"Idle.png"), 7, 0.1f);
        addAnimation("walk", loadTexture(asset+"Walk.png"), 7, 0.05f);
        addAnimation("attack", loadTexture(asset+"Attack_1.png"), 10, 0.05f);
        addAnimation("attack2", loadTexture(asset+"Attack_2.png"), 4, 0.05f);
        addAnimation("attack3", loadTexture(asset+"Light_ball.png"), 7, 0.05f);
        addAnimation("attack4", loadTexture(asset+"Light_Charge.png"), 13, 0.05f);
        addAnimation("run", loadTexture(asset+"Run.png"), 8, 0.01f);
        addAnimation("jump", loadTexture(asset+"Jump.png"), 8, 0.09f);
        addAnimation("protect", loadTexture(asset+"Idle.png"), 7, 2f);
        addAnimation("dead", loadTexture(asset+"Dead.png"), 5, 0.15f);
        addAnimation("hurt", loadTexture(asset+"Hurt.png"), 3, 0.09f);
    }
}
