...
public class SunMage extends Mage {
    ...
    public void loadAnimations() {
        ...
        addAnimation("walk", loadTexture(asset + "Walk.png"), 8, 0.05f);
        addAnimation("attack", loadTexture(asset + "Attack_1.png"), 10, 0.05f);
        addAnimation("attack2", loadTexture(asset + "Attack_2.png"), 10, 0.05f);
        addAnimation("attack3", loadTexture(asset + "Attack_3.png"), 7, 0.05f);
        addAnimation("run", loadTexture(asset + "Run.png"), 8, 0.01f);
        addAnimation("jump", loadTexture(asset + "Jump.png"), 10, 0.09f);
        addAnimation("protect", loadTexture(asset + "Idle_2.png"), 6, 2f);
        addAnimation("dead", loadTexture(asset + "Dead.png"), 10, 0.10f);
        addAnimation("hurt", loadTexture(asset + "Hurt.png"), 2, 0.09f);
    }
}
