...
public class Archer extends Mage {
    ...
    public void loadAnimations() {
        String asset = "archer/";
        addAnimation("idle", loadTexture(asset + "Idle.png"), 9, 0.1f);
        addAnimation("walk", loadTexture(asset + "Walk.png"), 8, 0.1f);
        addAnimation("attack", loadTexture(asset + "Attack_1.png"), 5, 0.05f);
        addAnimation("attack2", loadTexture(asset + "Attack_2.png"), 5, 0.05f);
        addAnimation("attack3", loadTexture(asset + "Attack_3.png"), 6, 0.05f);
        addAnimation("attack4", loadTexture(asset + "Shot.png"), 14, 0.05f);
        addAnimation("run", loadTexture(asset + "Run.png"), 8, 0.01f);
        addAnimation("jump", loadTexture(asset + "Jump.png"), 9, 0.09f);
        addAnimation("protect", loadTexture(asset + "Idle.png"), 9, 2f);
